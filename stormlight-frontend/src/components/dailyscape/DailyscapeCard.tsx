...
interface DailyscapeCardProps {
  isTestPage?: boolean
}

const DailyscapeCard = ({ isTestPage = false }: DailyscapeCardProps) => {
  ...
  // For /test page: use test-panel structure with header and body
  if (isTestPage) {
    return (
  ...
  // For production: use fantasy-section structure (original)
  return (
